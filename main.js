...
const starts = async (Syifa = new WAConnection()) => {
    ...
    Syifa.browserDescription = ['MB STORE','Chrome', '3.0']
    console.log(banner)
    Syifa.on('qr', () => {
        console.log(color('[SCAN ME]','red'), color('SCAN🔍'))
    })
...
if (anu.action == 'add' && !mem.includes(Syifa.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                welcomeBut = [{buttonId:`#intro`,buttonText:{displayText:'SELAMAT DATANG DI GRUP STORE KAMI ✅'},type:1}]
